"""
Django settings for testing_jobboard_38776 project.
...
ROOT_URLCONF = 'testing_jobboard_38776.urls'
...
WSGI_APPLICATION = 'testing_jobboard_38776.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testing_jobboard_38776 API",
    "DESCRIPTION": "API documentation for testing_jobboard_38776 App",
    "VERSION": "v1",
}
